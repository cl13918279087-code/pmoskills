...
| **战略决策** | PMO-01 | `strategy-charter-orchestrator` | 战略→章程→里程碑→WBS→进度编排链 |
...
| **项目规划** | PMO-05 | `project-oversight-risk-orchestrator` | 监控+风险联动编排链 |
...
| **项目规划** | PMO-09 | `wbs-schedule-milestone-orchestrator` | WBS→进度→里程碑编排链 |
...
| **成本管理** | PMO-13 | `earned-value-evm-orchestrator` | EVM全链条编排 |
| **质量管理** | PMO-10 | `architecture-review` | 架构评审 |
| **质量管理** | PMO-11 | `requirements-control` | 需求评审 |
| **质量管理** | PMO-15 | `compliance-check` | 合规检查 |
| **质量管理** | PMO-15 | `ethics-management-plan-writer` | 伦理合规管理计划 |
| **沟通协调** | PMO-06 | `stakeholder-comms-planner` | 干系人沟通计划 |
| **沟通协调** | PMO-08 | `cross-dept-coordination` | 跨部门协调 |
| **沟通协调** | PMO-08 | `cross-dept-solution-orchestrator` | 跨部门问题解决编排 |
| **沟通协调** | — | `org-stakeholder-communication-orchestrator` | 组织+沟通联动编排 |
...
| **供应商管理** | — | `vendor-risk-assessment` | 供应商风险评估 |
...
| 项目规划（WBS/进度/里程碑） | `project-control-agent` | `wbs-schedule-milestone-orchestrator` |
| 项目规划（成本/EVM） | `project-control-agent` | `earned-value-evm-orchestrator` |
| 项目规划（风险） | `project-control-agent` | `project-oversight-risk-orchestrator` |
...
| 供应商管理 | `project-inspection-agent` | `vendor-risk-assessment` |
| 跨部门协调 | `project-control-agent` | `cross-dept-solution-orchestrator` |
...
| `ethics-management-plan-writer` | 伦理合规管理计划 |
| `executive-communication` | 高管简报 |
| `lessons-learned-summarizer` | 经验教训总结报告 |
| `meeting-notes` | 会议纪要 |
| `milestone-planner` | 里程碑规划报告 |
| `org-stakeholder-communication-orchestrator` | 组织与干系人沟通编排 |
...
| `vendor-risk-assessment` | 供应商风险评估报告 |
...
| `vendor-risk-assessment` | 五维度（资质/绩效/技术/运营/合规）缺一不可 |
