...
治理与干系人沟通编排 Skill 从组织架构设计到干系人沟通策略进行全链路编排，确保项目治理结构清晰、干系人沟通有效，信息传递准确及时。
## When to use
...
## 信息采集（Step 0 — 治理与沟通编排前的上下文检查）

> ⚠️ **执行前必读**：本编排Skill需要明确项目的治理需求和干系人范围。信息缺失时应主动采集，而非直接执行编排流程。
...
| 治理类型 | 说明 | 适用场景 |
|---------|------|---------|
| 新项目启动 | 需要建立完整治理架构 | 项目初始化阶段 |
| 治理调整 | 现有治理架构需优化 | PM/组织变更 |
| 阶段切换 | 沟通需求变化 | 进入新项目阶段 |
| 问题驱动 | 现有治理/沟通有问题 | 协调失效、汇报断点 |

### Step 0.3 — 数据采集问题

**请逐项回答（已知的跳过，直接告知）：**

1. **项目基本信息**：项目名称、规模、当前阶段？
2. **关键干系人**：已识别哪些关键干系人？（干系人清单或类别）
3. **治理问题**：是否存在汇报路径不清晰、升版机制缺失等问题？
