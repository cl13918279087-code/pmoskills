...
战略决策编排 Skill 从战略决策 facilitation 到项目章程写作、里程碑规划进行全链路编排，引导组织将战略意图转化为可执行的项目治理框架。
## When to use
...
## 信息采集（Step 0 — 战略决策编排前的上下文检查）

> ⚠️ **执行前必读**：本编排Skill需要明确战略决策状态和项目背景。信息缺失时应主动采集，而非直接执行编排流程。

### Step 0.1 — 决策状态检查

| 数据项 | 是否已知 | 未提供时的处理 |
|--------|---------|--------------|
| 战略决策状态 | 请告知 | 说明是已决策还是待决策 |
| 项目背景 | 请告知 | 标注 `[假设值-请核对]` |
| 关键干系人 | 请告知 | 标注 `[假设值-请核对]` |
...
| 状态 | 说明 | 编排路径 |
|------|------|---------|
| 决策已做出 | 已有明确的战略决定或审批 | 直接进入Stage 2（章程编写） |
| 决策待推动 | 战略问题尚在分析阶段 | 完整执行Stage 1（决策推动） |

### Step 0.3 — 数据采集问题

**请逐项回答（已知的跳过，直接告知）：**

1. **决策状态**：战略决定是否已做出？（如：董事会已批准/监管已发文/待分析）
2. **项目背景**：项目名称、业务背景、战略环境？
3. **关键干系人**：有哪些关键干系人参与决策？
4. **决策截止日**：是否有硬性的决策截止日期？
