...
<p align="center">
  <img src="logo.svg" alt="project-management-skills logo" width="128" height="128" />
</p>

<p align="center">
  <img src="banner.svg" alt="project-management-skills banner" width="100%" />
</p>

<p align="center">
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="MIT License" /></a>
  <img src="https://img.shields.io/badge/skills-15-b91c1c" alt="15 skills" />
  <img src="https://img.shields.io/badge/focus-project%20management-991b1b" alt="project management" />
</p>

A platform-neutral project management skill pack for chartering, scope boundaries, milestones, sequencing, risk registers, estimation, and closure work.
...
```bash
git clone https://github.com/45ck/project-management-skills.git
...
```text
/project-charter-writer internal platform upgrade
/wbs-builder migration program
/milestone-planner quarter roadmap
/risk-register-builder multi-team rollout
/cost-estimation-helper new product initiative
/closure-report-writer completed implementation
```
...
- [delivery-manager](https://github.com/45ck/skill-harness) - Own chartering, milestones, risks, and sequencing
- [requirements-analyst](https://github.com/45ck/skill-harness) - Support scope framing and project boundaries
